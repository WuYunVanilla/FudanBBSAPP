...
import dandandateam.dandanda.RecommFragment.OnListRecommFragmentInteractionListener;
 ...
 * specified {@link OnListRecommFragmentInteractionListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class MyRecommRecyclerViewAdapter extends RecyclerView.Adapter<MyRecommRecyclerViewAdapter.ViewHolder> {

    private final List<MainQuestionItem> mValues;
    private final OnListRecommFragmentInteractionListener mListener;

    public MyRecommRecyclerViewAdapter(List<MainQuestionItem> items, OnListRecommFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onListRecommFragmentInteraction(holder.mItem);
                }
            }
        });
    }
