...
import dandandateam.dandanda.SearchFragment.OnListSearchFragmentInteractionListener;
 ...
 * specified {@link OnListSearchFragmentInteractionListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class MySearchFragmentRecyclerViewAdapter extends RecyclerView.Adapter<MySearchFragmentRecyclerViewAdapter.ViewHolder> {

    private final List<MainQuestionItem> mValues;
    private final OnListSearchFragmentInteractionListener mListener;

    public MySearchFragmentRecyclerViewAdapter(List<MainQuestionItem> items, OnListSearchFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onListSearchFragmentInteraction(holder.mItem);
                }
            }
        });
    }
